...
This program was written purely as a learning exercise, and is not intended for actual use. I wrote it as a fun little beginner project to learn about using Python to read data from other files, as well as using the 'string' and 'time' libraries.